...
public class Pet extends AllCharacter {
    ...
    public Pet(ImageView characterImageView, int speed, int posX, int posY, Set<KeyCode> activeKeys, List<Monster> monsters, AnchorPane gameWorld, ImageView PetProjectileImage) {
