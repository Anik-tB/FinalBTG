...
public class loginMonster extends AllCharacter{
    ...
    private List<loginMonster> monsters; // Add a reference to the list of monsters
    ...
    public loginMonster(ImageView characterImageView, int speed, int posX, int posY, int attackPower, int health, int attackRange, int minX, int minY, int maxX, int maxY,int monsterId,ImageView healthBar) {
    ...
    public void setMonsters(List<loginMonster> monsters) {
    ...
    public void chasePlayer(MainCharacter player) {
        ...
        if (monsters != null) {
            for (loginMonster otherMonster : monsters) {
    ...
    private boolean willCollide(int newPosX, int newPosY, loginMonster otherMonster) {
    ...
    public boolean isPlayerInActivationZone(MainCharacter player) {
        int activationRadius = 120; // Adjust as needed
        ...
        switch (monsterId) {
            ...
            case 31:
                if (lastDirection.equals("LEFT")) {
                    ...
                    getCharacterImageView().setImage(new Image(getClass().getResource("/image/monster/m9left.png").toExternalForm()));
                } else if (lastDirection.equals("RIGHT")) {
                    getCharacterImageView().setImage(new Image(getClass().getResource("/image/monster/m9right.png").toExternalForm()));

                } else if (lastDirection.equals("UP")) {
                    getCharacterImageView().setImage(new Image(getClass().getResource("/image/monster/m9up.png").toExternalForm()));

                } else if (lastDirection.equals("DOWN")) {
                    getCharacterImageView().setImage(new Image(getClass().getResource("/image/monster/m9down.png").toExternalForm()));
